...
def solve_dict(filename, debug):
    ...
    """
    my_dictionary = SimplexDictionary.parse_from_file(filename, "LINEAR", debug)
...
def main():
    ...
    for i in xrange(1,2):
        ...
        solve_dict("/Users/thomaswatson/code/coursera/linear/LinearSolver/dicts/initializationTests/unitTests/idict{0}".format(i), False)
